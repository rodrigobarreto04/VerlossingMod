...
public class RedemptiongemItem extends GemasOfRedemptionModElements.ModElement {
	@ObjectHolder("gemas_of_redemption:redemptiongem")
	public static final Item block = null;
	public RedemptiongemItem(GemasOfRedemptionModElements instance) {
		super(instance, 1);
	}
